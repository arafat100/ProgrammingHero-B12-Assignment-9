            ...
            <section class="bg-gray-100 py-16">
                <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
                    ...
                    <div class="bg-white rounded-xl shadow p-8 text-center">
                        <div class="w-12 h-12 mx-auto flex items-center justify-center text-lg font-semibold bg-gray-100 text-gray-600 rounded-xl mb-4">
                            1
                        </div>
                        <h3 class="text-lg font-semibold text-gray-600 mb-2">Create Account</h3>
                    ...
                    <div class="bg-white rounded-xl shadow p-8 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-600 mb-2">Complete Profile</h3>
                        <p class="text-gray-600 text-sm">
                    ...
                    <div class="bg-white rounded-xl shadow p-8 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-600 mb-2">Browse Skills</h3>
                        <p class="text-gray-600 text-sm">
                    ...
                    <div class="bg-white rounded-xl shadow p-8 text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-600 mb-2">Book a Session</h3>
                        <p class="text-gray-600 text-sm">
